...
* Updated the `/heal` command to allow healing specific amounts to both yourself and a target player. The command usage is now `/heal [amount] [player]` instead of `/heal [player]`. (@moisterrific)
