...
* Added config option `DisablePrimeBombs` for disabling Skeletron Prime bombs from spawning, as these bombs would bypass region protection and destroy tiles on `for the worthy` seed worlds. (@moisterrific)
