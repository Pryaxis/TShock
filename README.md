# TShock [![Build Status](https://travis-ci.org/NyxStudios/TShock.png?branch=general-devel)](https://travis-ci.org/NyxStudios/TShock) [![Slack](https://tshock-chat.herokuapp.com/badge.svg)](http://chat.tshock.co/)
