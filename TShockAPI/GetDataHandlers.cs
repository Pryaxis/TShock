...
namespace TShockAPI
{
    ...
    public static class GetDataHandlers
    {
        ...
        private static bool HandleTile(GetDataHandlerArgs args)
        {
            ...
            if (!args.Player.Group.HasPermission("editspawn") && RegionManager.InProtectedArea(x, y, args.Player.Name.ToLower()))
            {
            ...
            if (!args.Player.Group.HasPermission("editspawn") && !TShock.Login.Contains(args.Player.Name.ToLower()))
            {
                args.Player.SendMessage("Login to change this region", Color.Red);
                args.Player.SendTileSquare(x, y);
                return true;
