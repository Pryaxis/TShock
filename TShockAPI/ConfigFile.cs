...
namespace TShockAPI
{
	...
	public class ConfigFile
	{
		...
		/// <summary>Deprecated. Do not use this field. The server password required to join the server.</summary>
		[Description("The server password required to join the server.")]
		public string ServerPassword = "";

		/// <summary>Deprecated. Do not use this field. The port the server runs on.</summary>
		[Description("The port the server runs on.")]
		public int ServerPort = 7777;

		/// <summary>Deprecated. Do not use this field. Maximum number of clients connected at once. If lower than Terraria's setting, the server will kick excess connections.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The number of reserved slots past your max server slots that can be joined by reserved players.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Replaces the world name during a session if UseServerName is true.</summary>
		[Description("Replaces the world name during a session if UseServerName is true.")]
		public string ServerName = "";

		/// <summary>Deprecated. Do not use this field. Whether or not to use ServerName in place of the world name.</summary>
		[Description("Whether or not to use ServerName in place of the world name.")]
		public bool UseServerName = false;

		/// <summary>Deprecated. Do not use this field. The path to the directory where logs should be written to.</summary>
		[Description("The path to the directory where logs should be written to.")]
		public string LogPath = "tshock";

		/// <summary>Deprecated. Do not use this field. Whether or not the server should output debug level messages related to system operation.</summary>
		[Description("Whether or not the server should output debug level messages related to system operation.")]
		public bool DebugLogs = false;

		/// <summary>Deprecated. Do not use this field. Prevents users from being able to login before they finish connecting.</summary>
		[Description("Prevents users from being able to login before they finish connecting.")]
		public bool DisableLoginBeforeJoin;

		/// <summary>Deprecated. Do not use this field. Allows stacks in chests to go beyond the stack limit during world loading.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Enable or disable Terraria's built-in world auto save.</summary>
		[Description("Enable or disable Terraria's built-in world auto save.")]
		public bool AutoSave = true;

		/// <summary>Deprecated. Do not use this field. Enable or disable world save announcements.</summary>
		[Description("Enable or disable world save announcements.")]
		public bool AnnounceSave = true;

		/// <summary>Deprecated. Do not use this field. Whether or not to show backup auto save messages.</summary>
		[Description("Whether or not to show backup auto save messages.")]
		public bool ShowBackupAutosaveMessages = true;

		/// <summary>Deprecated. Do not use this field. The interval between backups, in minutes. Backups are stored in the tshock/backups folder.</summary>
		...
		/// <summary>Deprecated. Do not use this field. For how long backups are kept in minutes.</summary>
		[Description("For how long backups are kept in minutes.\neg. 2880 = 2 days.")]
		public int BackupKeepFor = 240;

		/// <summary>Deprecated. Do not use this field. Whether or not to save the world if the server crashes from an unhandled exception.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to save the world when the last player disconnects.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Determines the size of invasion events. The equation for calculating invasion size = 100 + (multiplier * (number of active players > 200 hp)).</summary>
		...
		/// <summary>Deprecated. Do not use this field. The default maximum number of mobs that will spawn per wave. Higher means more mobs in that wave.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The delay between waves. Lower values lead to more mobs.</summary>
		[Description("The delay between waves. Lower values lead to more mobs.")]
		public int DefaultSpawnRate = 600;

		/// <summary>Deprecated. Do not use this field. Enables never-ending invasion events. You still need to start the event.</summary>
		[Description("Enables never ending invasion events. You still need to start the event, such as with the /invade command.")]
		public bool InfiniteInvasion;

		/// <summary>Deprecated. Do not use this field. Sets the PvP mode. Valid types are: "normal", "always", "disabled".</summary>
		[Description("Sets the PvP mode. Valid types are: \"normal\", \"always\" and \"disabled\".")]
		public string PvPMode = "normal";

		/// <summary>Deprecated. Do not use this field. Prevents tiles from being placed within SpawnProtectionRadius of the default spawn.</summary>
		[Description("Prevents tiles from being placed within SpawnProtectionRadius of the default spawn.")]
		public bool SpawnProtection = true;

		/// <summary>Deprecated. Do not use this field. The tile radius around the spawn tile that is protected by the SpawnProtection setting.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Enable or disable anti-cheat range checks based on distance between the player and their block placements.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Prevents non-hardcore players from connecting.</summary>
		[Description("Prevents non-hardcore players from connecting.")]
		public bool HardcoreOnly;

		/// <summary>Deprecated. Do not use this field. Prevents softcore players from connecting.</summary>
		[Description("Prevents softcore players from connecting.")]
		public bool MediumcoreOnly;

		/// <summary>Deprecated. Do not use this field. Disables any placing, or removal of blocks.</summary>
		[Description("Disables any placing, or removal of blocks.")]
		public bool DisableBuild;

		/// <summary>Deprecated. Do not use this field. If enabled, hardmode will not be activated by the Wall of Flesh or the /starthardmode command.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Prevents the dungeon guardian from being spawned while sending players to their spawn point instead.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables clown bomb projectiles from spawning.</summary>
		[Description("Disables clown bomb projectiles from spawning.")]
		public bool DisableClownBombs;

		/// <summary>Deprecated. Do not use this field. Disables snow ball projectiles from spawning.</summary>
		[Description("Disables snow ball projectiles from spawning.")]
		public bool DisableSnowBalls;

		/// <summary>Deprecated. Do not use this field. Disables tombstone dropping during death for all players.</summary>
		[Description("Disables tombstone dropping during death for all players.")]
		public bool DisableTombstones = true;

		/// <summary>Deprecated. Do not use this field. Forces the world time to be normal, day, or night.</summary>
		[Description("Forces the world time to be normal, day, or night.")]
		public string ForceTime = "normal";

		/// <summary>Deprecated. Do not use this field. Disables the effect of invisibility potions while PvP is enabled by turning the player visible to the other clients.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The maximum distance, in tiles, that disabled players can move from.</summary>
		[Description("The maximum distance, in tiles, that disabled players can move from.")]
		public int MaxRangeForDisabled = 10;

		/// <summary>Deprecated. Do not use this field. Whether or not region protection should apply to chests.</summary>
		[Description("Whether or not region protection should apply to chests.")]
		public bool RegionProtectChests;

		/// <summary>Deprecated. Do not use this field. Whether or not region protection should apply to gem locks.</summary>
		[Description("Whether or not region protection should apply to gem locks.")]
		public bool RegionProtectGemLocks = true;

		/// <summary>Deprecated. Do not use this field. Ignores checks to see if a player 'can' update a projectile.</summary>
		[Description("Ignores checks to see if a player 'can' update a projectile.")]
		public bool IgnoreProjUpdate = false;

		/// <summary>Deprecated. Do not use this field. Ignores checks to see if a player 'can' kill a projectile.</summary>
		[Description("Ignores checks to see if a player 'can' kill a projectile.")]
		public bool IgnoreProjKill = false;

		/// <summary>Deprecated. Do not use this field. Allows players to break temporary tiles (grass, pots, etc) where they cannot usually build.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Allows ice placement even where a user cannot usually build.</summary>
		[Description("Allows ice placement even where a user cannot usually build.")]
		public bool AllowIce = false;

		/// <summary>Deprecated. Do not use this field. Allows the crimson to spread when a world is in hardmode.</summary>
		[Description("Allows the crimson to spread when a world is in hardmode.")]
		public bool AllowCrimsonCreep = true;

		/// <summary>Deprecated. Do not use this field. Allows the corruption to spread when a world is in hardmode.</summary>
		[Description("Allows the corruption to spread when a world is in hardmode.")]
		public bool AllowCorruptionCreep = true;

		/// <summary>Deprecated. Do not use this field. Allows the hallow to spread when a world is in hardmode.</summary>
		[Description("Allows the hallow to spread when a world is in hardmode.")]
		public bool AllowHallowCreep = true;

		/// <summary>Deprecated. Do not use this field. How many NPCs a statue can spawn within 200 pixels(?) before it stops spawning.</summary>
		[Description("How many NPCs a statue can spawn within 200 pixels(?) before it stops spawning.\nDefault = 3.")]
		public int StatueSpawn200 = 3;

		/// <summary>Deprecated. Do not use this field. How many NPCs a statue can spawn within 600 pixels(?) before it stops spawning.</summary>
		[Description("How many NPCs a statue can spawn within 600 pixels(?) before it stops spawning.\nDefault = 6.")]
		public int StatueSpawn600 = 6;

		/// <summary>Deprecated. Do not use this field. How many NPCs a statue can spawn before it stops spawning.</summary>
		[Description("How many NPCs a statue can spawn before it stops spawning.\nDefault = 10.")]
		public int StatueSpawnWorld = 10;

		/// <summary>Deprecated. Do not use this field. Prevent banned items from being spawned or given with commands.</summary>
		[Description("Prevent banned items from being spawned or given with commands.")]
		public bool PreventBannedItemSpawn = false;

		/// <summary>Deprecated. Do not use this field. Prevent players from interacting with the world while they are dead.</summary>
		[Description("Prevent players from interacting with the world while they are dead.")]
		public bool PreventDeadModification = true;

		/// <summary>Deprecated. Do not use this field. Prevents players from placing tiles with an invalid style.</summary>
		[Description("Prevents players from placing tiles with an invalid style.")]
		public bool PreventInvalidPlaceStyle = true;

		/// <summary>Deprecated. Do not use this field. Forces Christmas-only events to occur all year.</summary>
		[Description("Forces Christmas-only events to occur all year.")]
		public bool ForceXmas = false;

		/// <summary>Deprecated. Do not use this field. Forces Halloween-only events to occur all year.</summary>
		[Description("Forces Halloween-only events to occur all year.")]
		public bool ForceHalloween = false;

		/// <summary>Deprecated. Do not use this field. Allows groups on the banned item allowed list to spawn banned items even if PreventBannedItemSpawn is set to true.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The number of seconds a player must wait before being respawned. Cannot be longer than normal value now. Use at your own risk.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The number of seconds a player must wait before being respawned if there is a boss nearby. Cannot be longer than normal value now. Use at your own risk.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to announce boss spawning or invasion starts.</summary>
		[Description("Whether or not to announce boss spawning or invasion starts.")]
		public bool AnonymousBossInvasions = true;

		/// <summary>Deprecated. Do not use this field. The maximum HP a player can have, before equipment buffs.</summary>
		[Description("The maximum HP a player can have, before equipment buffs.")]
		public int MaxHP = 500;

		/// <summary>Deprecated. Do not use this field. The maximum MP a player can have, before equipment buffs.</summary>
		[Description("The maximum MP a player can have, before equipment buffs.")]
		public int MaxMP = 200;

		/// <summary>Deprecated. Do not use this field. Determines the range in tiles that a bomb can affect tiles from detonation point.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The default group name to place newly registered users under.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The default group name to place unregistered players under.</summary>
		[Description("The default group name to place unregistered players under.")]
		public string DefaultGuestGroupName = "guest";

		/// <summary>Deprecated. Do not use this field. Remembers where a player left off, based on their IP. Does not persist through server restarts.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Number of failed login attempts before kicking the player.</summary>
		[Description("Number of failed login attempts before kicking the player.")]
		public int MaximumLoginAttempts = 3;

		/// <summary>Deprecated. Do not use this field. Whether or not to kick mediumcore players on death.</summary>
		[Description("Whether or not to kick mediumcore players on death.")]
		public bool KickOnMediumcoreDeath;

		/// <summary>Deprecated. Do not use this field. The reason given if kicking a mediumcore players on death.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to ban mediumcore players on death.</summary>
		[Description("Whether or not to ban mediumcore players on death.")]
		public bool BanOnMediumcoreDeath;

		/// <summary>Deprecated. Do not use this field. The reason given if banning a mediumcore player on death.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Enable or disable the whitelist based on IP addresses in the whitelist.txt file.</summary>
		[Description("Enable or disable the whitelist based on IP addresses in the whitelist.txt file.")]
		public bool EnableWhitelist;

		/// <summary>Deprecated. Do not use this field. The reason given when kicking players for not being on the whitelist.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The reason given when kicking players that attempt to join while the server is full.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The reason given when kicking players that attempt to join while the server is full with no reserved slots available.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to kick hardcore players on death.</summary>
		[Description("Whether or not to kick hardcore players on death.")]
		public bool KickOnHardcoreDeath;

		/// <summary>Deprecated. Do not use this field. The reason given when kicking hardcore players on death.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to ban hardcore players on death.</summary>
		[Description("Whether or not to ban hardcore players on death.")]
		public bool BanOnHardcoreDeath;

		/// <summary>Deprecated. Do not use this field. The reason given when banning hardcore players on death.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Enables kicking banned users by matching their IP Address.</summary>
		[Description("Enables kicking banned users by matching their IP Address.")]
		public bool EnableIPBans = true;

		/// <summary>Deprecated. Do not use this field. Enables kicking banned users by matching their client UUID.</summary>
		[Description("Enables kicking banned users by matching their client UUID.")]
		public bool EnableUUIDBans = true;

		/// <summary>Deprecated. Do not use this field. Enables kicking banned users by matching their Character Name.</summary>
		[Description("Enables kicking banned users by matching their Character Name.")]
		public bool EnableBanOnUsernames;

		/// <summary>Deprecated. Do not use this field. If GeoIP is enabled, this will kick users identified as being under a proxy.</summary>
		[Description("If GeoIP is enabled, this will kick users identified as being under a proxy.")]
		public bool KickProxyUsers = true;

		/// <summary>Deprecated. Do not use this field. Require all players to register or login before being allowed to play.</summary>
		[Description("Require all players to register or login before being allowed to play.")]
		public bool RequireLogin;

		/// <summary>Deprecated. Do not use this field. Allows users to login to any account even if the username doesn't match their character name.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Allows users to register a username that doesn't necessarily match their character name.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The minimum password length for new user accounts. Can never be lower than 4.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The hash algorithm used to encrypt user passwords.
		...
		/// <summary>Deprecated. Do not use this field. Determines the BCrypt work factor to use. If increased, all passwords will be upgraded to new work-factor on verify.
		...
		/// <summary>Deprecated. Do not use this field. Prevents users from being able to login with their client UUID.</summary>
		[Description("Prevents users from being able to login with their client UUID.")]
		public bool DisableUUIDLogin;

		/// <summary>Deprecated. Do not use this field. Kick clients that don't send their UUID to the server.</summary>
		[Description("Kick clients that don't send their UUID to the server.")]
		public bool KickEmptyUUID;

		/// <summary>Deprecated. Do not use this field. Disables a player if this number of tiles is painted within 1 second.</summary>
		[Description("Disables a player if this number of tiles is painted within 1 second.")]
		public int TilePaintThreshold = 15;

		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the TilePaint threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The maximum damage a player/NPC can inflict.</summary>
		[Description("The maximum damage a player/NPC can inflict.")]
		public int MaxDamage = 1175;

		/// <summary>Deprecated. Do not use this field. The maximum damage a projectile can inflict.</summary>
		[Description("The maximum damage a projectile can inflict.")]
		public int MaxProjDamage = 1175;

		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the MaxDamage threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables a player and reverts their actions if this number of tile kills is exceeded within 1 second.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the TileKill threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables a player and reverts their actions if this number of tile places is exceeded within 1 second.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the TilePlace threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables a player if this number of liquid sets is exceeded within 1 second.</summary>
		[Description("Disables a player if this number of liquid sets is exceeded within 1 second.")]
		public int TileLiquidThreshold = 50;

		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the TileLiquid threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to ignore shrapnel from crystal bullets for the projectile threshold count.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disable a player if this number of projectiles is created within 1 second.</summary>
		[Description("Disable a player if this number of projectiles is created within 1 second.")]
		public int ProjectileThreshold = 50;

		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the Projectile threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables a player if this number of HealOtherPlayer packets is sent within 1 second.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the HealOther threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Disables a player if this number of tiles is present in a Tile Rectangle packet</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to kick users when they surpass the TileRectangleSize threshold.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Specifies which string starts a command.
		...
		/// <summary>Deprecated. Do not use this field. Specifies which string starts a command silently.
		/// Note: Will not function properly if the string length is bigger than 1.</summary>
		[Description("Specifies which string starts a command silently.\nNote: Will not function properly if the string length is bigger than 1.")]
		public string CommandSilentSpecifier = ".";

		/// <summary>Deprecated. Do not use this field. Disables sending logs as messages to players with the log permission.</summary>
		[Description("Disables sending logs as messages to players with the log permission.")]
		public bool DisableSpewLogs = true;

		/// <summary>Deprecated. Do not use this field. Prevents OnSecondUpdate checks from writing to the log file.</summary>
		[Description("Prevents OnSecondUpdate checks from writing to the log file.")]
		public bool DisableSecondUpdateLogs = false;

		/// <summary>Deprecated. Do not use this field. The chat color for the superadmin group.</summary>
		[Description("The chat color for the superadmin group.\n#.#.# = Red/Blue/Green\nMax value: 255")]
		public int[] SuperAdminChatRGB = { 255, 255, 255 };

		/// <summary>Deprecated. Do not use this field. The superadmin chat prefix.</summary>
		[Description("The superadmin chat prefix.")]
		public string SuperAdminChatPrefix = "(Super Admin) ";

		/// <summary>Deprecated. Do not use this field. The superadmin chat suffix.</summary>
		[Description("The superadmin chat suffix.")]
		public string SuperAdminChatSuffix = "";

		/// <summary>Deprecated. Do not use this field. Whether or not to announce a player's geographic location on join, based on their IP.</summary>
		[Description("Whether or not to announce a player's geographic location on join, based on their IP.")]
		public bool EnableGeoIP;

		/// <summary>Deprecated. Do not use this field. Displays a player's IP on join to users with the log permission.</summary>
		[Description("Displays a player's IP on join to users with the log permission.")]
		public bool DisplayIPToAdmins;

		/// <summary>Deprecated. Do not use this field. Changes in-game chat format: {0} = Group Name, {1} = Group Prefix, {2} = Player Name, {3} = Group Suffix, {4} = Chat Message.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Changes the player name when using chat above heads. Starts with a player name wrapped in brackets, as per Terraria's formatting.\nSame formatting as ChatFormat without the message.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Whether or not to display chat messages above players' heads.</summary>
		[Description("Whether or not to display chat messages above players' heads.")]
		public bool EnableChatAboveHeads = false;

		/// <summary>Deprecated. Do not use this field. The RGB values used for the color of broadcast messages.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The type of database to use when storing data (either "sqlite" or "mysql").</summary>
		[Description("The type of database to use when storing data (either \"sqlite\" or \"mysql\").")]
		public string StorageType = "sqlite";

		/// <summary>Deprecated. Do not use this field. The path of sqlite db.</summary>
		[Description("The path of sqlite db.")]
		public string SqliteDBPath = "tshock.sqlite";

		/// <summary>Deprecated. Do not use this field. The MySQL hostname and port to direct connections to.</summary>
		[Description("The MySQL hostname and port to direct connections to.")]
		public string MySqlHost = "localhost:3306";

		/// <summary>Deprecated. Do not use this field. The database name to connect to when using MySQL as the database type.</summary>
		[Description("The database name to connect to when using MySQL as the database type.")]
		public string MySqlDbName = "";

		/// <summary>Deprecated. Do not use this field. The username used when connecting to a MySQL database.</summary>
		[Description("The username used when connecting to a MySQL database.")]
		public string MySqlUsername = "";

		/// <summary>Deprecated. Do not use this field. The password used when connecting to a MySQL database.</summary>
		[Description("The password used when connecting to a MySQL database.")]
		public string MySqlPassword = "";

		/// <summary>Deprecated. Do not use this field. Whether or not to save logs to the SQL database instead of a text file.</summary>
		[Description("Whether or not to save logs to the SQL database instead of a text file.\nDefault = false.")]
		public bool UseSqlLogs = false;

		/// <summary>Deprecated. Do not use this field. Number of times the SQL log must fail to insert logs before falling back to the text log.</summary>
		...
		/// <summary>Deprecated. Do not use this field. Enable or disable the REST API.</summary>
		[Description("Enable or disable the REST API.")]
		public bool RestApiEnabled;

		/// <summary>Deprecated. Do not use this field. The port used by the REST API.</summary>
		[Description("The port used by the REST API.")]
		public int RestApiPort = 7878;

		/// <summary>Deprecated. Do not use this field. Whether or not to log REST API connections.</summary>
		[Description("Whether or not to log REST API connections.")]
		public bool LogRest = false;

		/// <summary>Deprecated. Do not use this field. Whether or not to require token authentication to use the public REST API endpoints.</summary>
		...
		/// <summary>Deprecated. Do not use this field. The maximum REST requests in the bucket before denying requests. Minimum value is 5.</summary>
		...
		/// <summary>Deprecated. Do not use this field. How often in minutes the REST requests bucket is decreased by one. Minimum value is 1 minute.</summary>
		...
		/// <summary>Deprecated. Do not use this field. A dictionary of REST tokens that external applications may use to make queries to your server.</summary>
