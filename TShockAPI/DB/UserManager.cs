...
namespace TShockAPI.DB
{
	...
	#region User Shim for User{....} -> UserAccount{....}
	/// <summary>
	/// Shim for <see cref="UserAccount"/>
	/// </summary>
	[Obsolete("This class only exists as a shim. Please use the UserAccount class instead")]
	public class User : UserAccount, IEquatable<User>
	{
		/// <summary>
		/// Shim for <see cref="UserAccount()"/>
		/// </summary>
		[Obsolete("This constructor only exists as a shim. Please use the UserAccount.UserAccount() constructor instead.")]
		public User() : base()
		{
		}

		/// <summary>
		/// Shim for <see cref="UserAccount(string, string, string, string, string, string, string)"/>
		/// </summary>
		...
		[Obsolete("This constructor only exists as a shim. Please use the UserAccount.UserAccount(string, string, string, string, string, string, string) constructor instead.")]
		public User(string name, string pass, string uuid, string group, string registered, string last, string known) : base(name, pass, uuid, group, registered, last, known)
		{
		}
	...
	/// <summary>
	/// Shim for <see cref="UserAccountManagerException"/>
	/// </summary>
	[Serializable]
	[Obsolete("This class only exists as a shim. Please use the UserAccountManagerException class instead")]
	public class UserManagerException : UserAccountManagerException
	{
	...
	/// <summary>
	/// Shim for <see cref="UserAccountExistsException"/>
	/// </summary>
	[Serializable]
	[Obsolete("This class only exists as a shim. Please use the UserAccountExistsException class instead")]
	public class UserExistsException : UserAccountExistsException
	{
		public UserExistsException(string name) : base(name)
		{
		}
	}

	/// <summary>
	/// Shim for <see cref="UserAccountNotExistException"/>
	/// </summary>
	[Serializable]
	[Obsolete("This class only exists as a shim. Please use the UserAccountNotExistException class instead")]
	public class UserNotExistException : UserAccountNotExistException
	{
		public UserNotExistException(string name) : base(name)
		{
		}
	}
	#endregion
